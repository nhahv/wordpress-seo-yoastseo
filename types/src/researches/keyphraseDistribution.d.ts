 ...
 */
export function computeScoresPerSentenceShortTopic(topic: any[], sentences: any[], locale: string): any[];
/**
 ...
 * @returns {Array} The scores per sentence.
 */
export function computeScoresPerSentenceLongTopic(topic: any[], sentences: any[], locale: string): any[];
/**
