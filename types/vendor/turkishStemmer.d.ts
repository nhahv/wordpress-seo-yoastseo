...
declare class Among {
    ...
    set s(arg: any);
    get s(): any;
    set substring_i(arg: any);
    get substring_i(): any;
    set result(arg: any);
    get result(): any;
    set methodobject(arg: any);
