 ...
 */
export default function _default(matchString: string, positiveLookAhead?: boolean | undefined, extraWordBoundary?: string | undefined, locale?: string | undefined): string;
