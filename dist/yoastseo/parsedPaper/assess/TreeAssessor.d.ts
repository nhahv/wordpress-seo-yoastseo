...
declare class TreeAssessor {
     ...
     */
    assess(paper: any, node: any): Promise<{
     ...
     */
    applyAssessment(assessment: any, paper: any, node: any): Promise<AssessmentResult>;
    /**
     ...
     */
    getAssessment(name: string): any | null;
    /**
     ...
     */
    getApplicableAssessments(paper: any, node: any): Promise<Array>;
}
