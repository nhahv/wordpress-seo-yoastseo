 ...
 */
export function calculateTotalNumberOfSyllables(word: string): any;
/**
 ...
 */
export function checkBeginningsList(word: string, prefixLength: any, beginnings: string[]): boolean;
