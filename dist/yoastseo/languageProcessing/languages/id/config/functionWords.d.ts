 ...
 */
export const filteredAtEnding: string[];
/**
 ...
 */
export const filteredAtBeginning: string[];
/**
 ...
 */
export const filteredAtBeginningAndEnding: string[];
/**
 * These word categories are filtered everywhere within word combinations.
 *
 * @type {string[]} Word categories filtered anywhere within word combinations.
 */
export const filteredAnywhere: string[];
/**
